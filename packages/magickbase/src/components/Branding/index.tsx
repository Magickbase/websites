...
export const Branding: FC = () => (
  <div className={classnames(`relative flex flex-col justify-center items-center text-center h-screen`)}>
    <div className="container md:px-12">
      ...
      <p className="text-3xl">We're proud of the products we've built, the communities we've supported, and the impact we've made on the world, leading the charge in the decentralized revolution.</p>
    </div>
